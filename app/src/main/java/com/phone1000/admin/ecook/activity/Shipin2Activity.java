...
public class Shipin2Activity extends Activity implements OnCompletionListener, OnInfoListener {
...
//         ~~~ 获取播放地址和标
//         ~~~ 绑定控件
        setContentView(R.layout.activity_shipin2);
        mPath = getIntent().getStringExtra("video");
