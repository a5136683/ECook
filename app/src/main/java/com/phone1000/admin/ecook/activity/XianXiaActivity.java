...
public class XianXiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xian_xia);
        initView();
        setData();
    }
    private void setData() {
        ...
        teach_XianXia_web.setWebChromeClient(new WebChromeClient(){
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                if (newProgress<100){
                    Toast.makeText(XianXiaActivity.this,"正在努力加载",Toast.LENGTH_SHORT).show();
                }
            }
        });
        //支持缩放
...
//		webShow.setLoadWithOverviewMode(true);
    ...
    private void initView() {
        ...
        teach_XianXia_web=(WebView) findViewById(R.id.teach_XianXia_web);
    }
